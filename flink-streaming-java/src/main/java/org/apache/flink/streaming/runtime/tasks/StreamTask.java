...
public abstract class StreamTask<OUT, OP extends StreamOperator<OUT>>
     ...
     * future.
     */
    protected final TimerService timerService; // 多易教育:  可以用来注册用户的定时器
     ...
     */
    protected final TimerService systemTimerService;  // 多易教育:  只用于系统内部的定时器
    ...
    public ProcessingTimeServiceFactory getProcessingTimeServiceFactory() {  // 多易教育:  工厂方法的逻辑定义
        return mailboxExecutor ->
                new ProcessingTimeServiceImpl(
                        timerService,
                        callback -> deferCallbackToMailbox(mailboxExecutor, callback)); // 多易教育:  将callback的执行推送到mailBox
    }

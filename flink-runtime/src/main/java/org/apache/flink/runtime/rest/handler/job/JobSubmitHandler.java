...
public final class JobSubmitHandler
    ...
    protected CompletableFuture<JobSubmitResponseBody> handleRequest(
        ...
        final Collection<File> uploadedFiles = request.getUploadedFiles(); // 多易教育:  flink-jobgraph173..bin;demo.jar
        ...
        // 多易教育:  JobSubmitRequestBody{jobGraphFileName='flink-jobgraph17371039931575138841.bin', jarFileNames=[demo.jar], artifactFileNames=[]}
        ...
        // 多易教育:  从文件中加载jobgraph.bin文件反序列化成jobGraph对象
        ...
        // 多易教育:  gateway: address=akka.tcp://flink@localhost:6123/user/rpc/dispatcher_0; rpcEndpoint(LocalActorRef)=Actor[akka://flink/user/rpc/dispatcher_0#440732603] 本地actorRef
